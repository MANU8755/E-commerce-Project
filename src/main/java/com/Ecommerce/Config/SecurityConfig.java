     ...
     SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		return http
                ...
                .authorizeHttpRequests(
                        req->req.requestMatchers("/getsellerProducts/**","/getProduct/**","/category/**","/register/**","/login/**","/getAllUsers/**","/sellerRegister/**","/getsellerdetails/**","/product/**","/cart/**","/order/**","/getProductByCategory/**")
                                .permitAll()
